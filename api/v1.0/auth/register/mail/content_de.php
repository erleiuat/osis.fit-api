...
$_MailEngine->subject = "Aktiviere dein Konto bei Osis.fit!";
$_MailEngine->body = [
    "content.inner2" => '
        <br/>
        ...
        Oder nutze diesen Code auf <a href="https://osis.fit/auth/verify">osis.fit/auth/verify</a>: <br/><br/>
        <strong>'.$_Auth->verify_code.'</strong>
    ',
    "header.heading1" => "Willkommen bei Osis.fit!",
    "header.heading2" => "Konto Aktivieren",
